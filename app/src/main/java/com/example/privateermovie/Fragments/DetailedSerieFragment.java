 ...
 * Use the {@link DetailedSerieFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DetailedSerieFragment extends Fragment {
    ...
    public static DetailedSerieFragment newInstance(String param1, String param2) {
        DetailedSerieFragment fragment = new DetailedSerieFragment();
    ...
    public static DetailedSerieFragment newInstance(SeriesModel.Result selectedSerie) {
        DetailedSerieFragment fragment = new DetailedSerieFragment();
        Bundle args = new Bundle();
        args.putSerializable("selectedSerie", selectedSerie);
        fragment.setArguments(args);
        return fragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            mSelectedSerie = (SeriesModel.Result) getArguments().getSerializable("selectedSerie");
        }
    }
